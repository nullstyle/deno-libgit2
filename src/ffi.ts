...
/**
 * Get the library file name based on the operating system
 */
...
/**
 * Common library search paths by OS
 */
export function getLibrarySearchPaths(): string[] {
  switch (Deno.build.os) {
    case "windows":
      return [
        "git2.dll",
        "C:\\Program Files\\Git\\mingw64\\bin\\git2.dll",
        "C:\\Program Files (x86)\\Git\\mingw32\\bin\\git2.dll",
      ];
    case "darwin":
      return [
        "libgit2.dylib",
