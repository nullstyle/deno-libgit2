...
This document tracks the implementation status of the libgit2 API in the `deno-libgit2` package.

**Source:** [libgit2 API Reference (main)](https://libgit2.org/docs/reference/main/)
