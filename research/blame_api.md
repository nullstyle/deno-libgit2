...
The blame API decorates individual lines in a file with the commit that
introduced that particular line.
...
- GIT_BLAME_TRACK_COPIES_SAME_COMMIT_MOVES (1 << 1) - Track lines moved in same
  commit
- GIT_BLAME_TRACK_COPIES_SAME_COMMIT_COPIES (1 << 2) - Track lines copied in
  same commit
- GIT_BLAME_TRACK_COPIES_ANY_COMMIT_COPIES (1 << 3) - Track lines copied from
  any commit
