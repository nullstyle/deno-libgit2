...
The mailmap API provides functions for parsing and resolving author/committer name and email mappings. This is useful for normalizing contributor identities across a repository's history.
...
```
Create a new mailmap from a repository, loading mailmap files based on configuration:
